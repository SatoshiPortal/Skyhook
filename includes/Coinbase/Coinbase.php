...
class Coinbase
{
    ...
    {
        return new Coinbase(new ApiKeyAuthentication($key, $secret));
    }

    public static function withSimpleApiKey($key)
    {
        return new Coinbase(new SimpleApiKeyAuthentication($key));
    }

    public static function withOAuth($oauth, $tokens)
    {
        return new Coinbase(new OAuthAuthentication($oauth, $tokens));
    }
    ...
    public function __construct($authentication, $tokens=null, $apiKeySecret=null)
    {
        ...
        if (is_a($authentication, 'Coinbase\Authentication')) {
    ...
    {
        return $this->get("accounts/" . $accountId . "/balance", array())->amount;
    }
    ...
    {
        return $this->get("payment_methods", array());
    }
    ...
    {
	sendMoneyFromAccountId(null, $to, $amount, $notes, $userFee, $amountCurrency);
    }

    public function sendMoneyFromAccountId($accountId = null, $to, $amount, $notes=null, $userFee=null, $amountCurrency=null)
    {
